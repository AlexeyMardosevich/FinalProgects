...
<form action="${pageContext.request.contextPath}/orders/edit/${order.id}" method="post">
    ...
    <input id="input-cost" type="number" name="cost" value="${order.cost}" step="0.01" min="0" required>
    <br/><br/>
    <input type="submit" value="Save">
</form>
<br/>
<a href="${pageContext.request.contextPath}/orders/${order.id}">Back to order</a>
</body>
</html>