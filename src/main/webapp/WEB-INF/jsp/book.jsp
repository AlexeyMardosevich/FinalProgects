...
<html>
<head>
    <title><fmt:message bundle="${msg}" key="book.Title"/></title>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/style.css">
</head>
<body>
<jsp:include page="navbar.jsp"/>
<h1><fmt:message bundle="${msg}" key="book.Book"/></h1>
<h2><fmt:message bundle="${msg}" key="book.Id"/></h2>
<p>${book.id}</p>
<h2><fmt:message bundle="${msg}" key="book.Name"/></h2>
<p>${book.name}</p>
<h2><fmt:message bundle="${msg}" key="book.Author"/></h2>
<p>${book.author}</p>
<h2><fmt:message bundle="${msg}" key="book.Price"/></h2>
<p>${book.price}</p>
<hr/>
<h2>Add to cart</h2>
<form action="${pageContext.request.contextPath}/cart/items"
        method="post">
